...
TBNAME = "testbench_hic"

CHIP_MAP = []

#GTH_SUBSET table is at the bottom of setup.txt!!!
GTH_SUBSET = [0,1,26] # Single HIC map
...
for i in [0,1,8]: CHIP_MAP.append((0,i)) #J2

SETUP_PULSE = True #configure pixels for masking if true; otherwise, use the masklist from text file
...
USE_USB_COMM = False #This relates to CRU
