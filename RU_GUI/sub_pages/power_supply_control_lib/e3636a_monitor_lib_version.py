...
"""
def PS_0_serial_connect(self):
	self.PS_0_ser = serial.Serial(PS_0_USB_ID, 9600, timeout=1, dsrdtr=True)
	self.PS_0_ser.flush()
	self.PS_0_ser.write("SYST:REM\r\n".encode())
"""


def PS_0_serial_connect_debug(self):
	print ("this is from e3636a lib")
	self.debug_ser = "PS_0_debug_ser"
